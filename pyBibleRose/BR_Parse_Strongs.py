...
def parse_strongs_greek_xml(url):
    ...
    for entry in entries:
        ...
        strongs_key = f"G{int(strongs_number):05d}"  # Format to G00003
        ...
        original = greek_elem.attrib.get("unicode", "").strip() if greek_elem is not None else ""
